...
#import "IVEHomeViewController.h"

#import "IVEViewController.h"

@interface IVEHomeViewController ()

@end

@implementation IVEHomeViewController
...
- (IBAction)openMenu:(id)sender {
    NSLog(@"IVEHomeViewController openMenu");
